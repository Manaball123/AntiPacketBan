...
public abstract class TinyProtocol {
    ...
    //private static final Class<?> playerConnectionClass = net.minecraft.server.network.ServerPlayerConnection.class;
    ...
    private static final MethodInvoker getPlayerHandle = Reflection.getMethod(CraftPlayer.class, "getHandle");
    ...
    private static final FieldAccessor<?> getManager = Reflection.getField(playerConnectionClass, networkManagerClass, 0);
    ...
    //private static final Class<?> PACKET_LOGIN_IN_START = Reflection.getClass("{nms}.PacketLoginInStart", "net.minecraft.network.protocol.login.ClientboundGameProfilePacket");
    private static final Class<?> PACKET_LOGIN_IN_START = ClientboundGameProfilePacket.class;
    ...
    public TinyProtocol(final Plugin plugin) {
        ...
        plugin.getLogger().info("TinyProtocol Initialized.");
    }
    ...
    public Channel getChannel(Player player) {
        ...
        if (channel == null) {
            ...
            {
                plugin.getLogger().warning("WHAT THE FUCK AAA");
                e.printStackTrace();
            }
